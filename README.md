...
| Module | Topic | Reference |
| --- | --- | --- |
| `article1_deepwater_gom_overview` | Deepwater GoM overview: water-depth classification, seawater hydrostatic head, water-column-reduced overburden pressure/gradient (narrow margin), porosity-permeability decoupling (~3 orders), reservoir-quality lookup by play (Pleistocene/Pliocene/Miocene/Wilcox), dual-gradient mud-line pressure relief | Elshahawi, pp. 81–87 |
| `article2_turbidite_sediments` | Turbidite sediments: Bouma Ta-Te fining-upward sequence, net-to-gross & sand-to-sand pore contact (layered 45%/3% vs amalgamated 90%/67%, Ross Fm) with recovery proxy, submarine-fan facies belts & reservoir-quality rank (outer fan best), mass-transport-deposit progression | Dribus, pp. 88–95 |
| `article3_reservoir_fluid_dynamics` | Reservoir-fluid dynamics: 1D diffusion x²=2Dt (Eq. 1), gravity-current velocity (Eq. 2), asphaltene Boltzmann distribution (Eq. 3) & gradient half-height, Yen-Mullins sizes, diffusion-vs-GOC-displacement comparison (~20 m), reservoir-equilibrium state (young/aged) | Mullins, Zuo, Wang, Hammond, De Santo, Dumont, Mishra, Chen, Pomerantz, Dong, Elshahawi & Seifert, pp. 96–112 |
| `article4_asphaltene_fault_block_migration` | Asphaltene fault-block migration: Flory-Huggins-Zuo EoS (gravity/entropy/solubility, Eq. 1) & gravity-only limit, molar-volume/particle-size inference, fault-block vertical offset, FHZ connectivity/fault-seal test, 35-40 wt% tar-mat cutoff | Dong, Hows, Cornelisse & Elshahawi, pp. 113–123 |
| `article5_deepwater_formation_evaluation` | Deepwater formation evaluation: ECD drilling-window check, Eaton pore pressure, anisotropy ratio λ=√(Rv/Rh), Thomas-Stieber laminated Rh/Rv (+shale-anisotropy correction) & Archie sand Sw, NMR hydrogen index, Coates permeability, T1 fluid typing | Chemali, Samec, Balliet, Cooper, Torres & Jones, pp. 124–135 |
| `article6_kerogen_resistivity_mudrocks` | Kerogen effect on resistivity: saturation/porosity/kerogen volumetrics (Eqs. 1-6), plagioclase-quartz (Eq. 8) & TOC→kerogen (Eq. 9) constraints, exponential effective kerogen resistivity (Eq. 10), finite-difference Laplace solver ∇·(σ∇V)=0 (Eq. 7), ~1000 Ω·m conductivity threshold, Archie Sw overestimation | Kethireddy, Chen & Heidari, pp. 136–146 |

No DOIs: this issue predates SPWLA DOI assignment, so modules cite Vol. 55, No. 2 page ranges instead. Equations are standard-form reconstructions. See `src2014_04/README.md`.
